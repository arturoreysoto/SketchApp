...
- ➡️ Arrow — point to anything with Shift + Line
...
- ⌨️ Global shortcut — `⌘ ⌥ ⇧ G` to show/hide
...
1. Download the latest release from [GitHub Releases](https://github.com/arturoreysoto/SketchOver/releases)
2. Move `Sketch Over.app` to your Applications folder
3. Open it — it will appear in your menubar

Or build from source:

```bash
git clone https://github.com/arturoreysoto/SketchOver.git
cd SketchOver
open SketchOver.xcodeproj
```

## Usage

- Launch Sketch Over from your menubar
- Press `⌘ ⌥ ⇧ G` to show or hide the toolbar
- Select a tool and draw over any window
- Press 1–6 to switch tools instantly
- Hold ⇧ with Line to draw arrows
...
Made with ❤️ for macOS by [Magic Apps Lab](https://magicappslab.app/)
